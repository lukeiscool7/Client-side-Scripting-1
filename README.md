...
<h2><i>Benifits to learning how to use HTML(Hypertext)</i></h2>

<ul style="list-style-type:circle;">
  <li>Basic Web Skills: HTML is essential for creating web pages.</li>
  <li>Understanding Web Content: Learning HTML helps understand how web content is structured.</li>
  <li>Improved Collaboration: Knowing HTML enables better communication with web developers and designers.</li>
</ul>  
...
<table>
  ...
  <tr>
    <td>HTML</td>
    <td> Markup language used for creating and structuring web pages</td>
    <td>Tim Berners-Lee</td>
  </tr>
  <tr>
    <td>Hypertext</td>
    <td>Web-based organization method using hyperlinks to navigate related content </td>
    <td> Ted Nelson </td>
  </tr>
  <tr>
    <td>Java script</td>
    <td> Add interactivity to web pages </td>
    <td>Brendan Eich</td>
  </tr>
  <tr>
    <td>Python</td>
    <td>High-level programming language known for its simplicity and readability</td>
    <td>Guido van Rossum</td>
  </tr>
  <tr>
    <td>SQL</td>
    <td>Language for managing relational databases</td>
    <td>Chamberlin and Boyce</td>
  </tr>
  <tr>
    <td>CSS</td>
    <td>Styling language for web pages</td>
    <td>Lie and Bos.</td>
  </tr>
</table>
  ...
  Additional links:
    <ol>
        <li><i><a href="https://www.techopedia.com/definition/5177/hypertext">Techopedia</a></i></li>
        <li><i><a href="https://techterms.com/definition/hypertext">Tech-terms</a></i></li>
        <li><i><a href="https://www.youtube.com/watch?v=f6o33ylERpU">Youtube</a></i></li>
    </ol>
    <b><p>Included link to <a href="https://github.com/lukeiscool7/Client-side-Scripting-1/blob/main/README.md?plain=1">My markdown page</a>.</p><b>
  </body>
</html>
